...
const Navbar = () => {
  ...
  return (
    <div className="navbar fixed top-0 left-0 w-full py-7 flex items-center justify-between z-50">
      <div className="logo">
      ...
      <ul
        ...
        md:-translate-x-0 md:opacity-100 bg-white/30 backdrop-blur-md 
